...
import Store.store.service.imp.CustomerServiceImp;
import Store.store.service.imp.GoodsServiceImp;
import Store.store.service.imp.OrdersServiceImp;
...
public class Controller extends javax.servlet.http.HttpServlet {
    ...
    protected void doGet(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws javax.servlet.ServletException, IOException {
        ...
        if ("reg".equals(action)) {
            ...
            request.setAttribute("goodsList", goodsList.subList(start, end));//取下标start到end-1
...
//                 min *= 10;           
//                 max *= 10;        }     
//             long ordersid = (((long) (new Random().nextDouble() * (max - min)))) + min ;
